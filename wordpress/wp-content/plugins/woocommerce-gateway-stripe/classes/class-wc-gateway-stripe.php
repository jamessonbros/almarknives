		...
		<fieldset>
			...
			<?php if ( is_user_logged_in() && ( $credit_cards = get_user_meta( get_current_user_id(), '_stripe_customer_id', false ) ) ) : 
				...
				<p class="form-row form-row-wide">
					...
					<input type="radio" id="new" name="stripe_customer_id" style="width:auto;" <?php checked( $checked, 1 ) ?> value="new" /> <label style="display:inline;" for="new"><?php _e( 'Use a new credit card', 'wc_stripe' ); ?></label>
