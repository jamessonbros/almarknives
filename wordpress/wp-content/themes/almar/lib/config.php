 ...
 */
define('GOOGLE_ANALYTICS_ID', 'UA-438885-26'); // UA-XXXXX-Y (Note: Universal Analytics only, not Classic Analytics)
...
function roots_display_sidebar() {
  $sidebar_config = new Roots_Sidebar(
    ...
    array(
      'is_404',
      'is_front_page',
      array('is_singular', array('product')),
    ),
    /**
